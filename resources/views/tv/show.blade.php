	...
	<div class="tv-info border-b border-gray-800">
		<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
			...
			<div class="md:ml-24">
                ...
                </div> <!-- end of parent x-data container -->
                ...
                @foreach($tvshow['images'] as $image)
    				...
    				<div class="mt-8">
                        <a
                            ...
                            href="#"
                        >
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path'] }}" alt="backdrops" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>
